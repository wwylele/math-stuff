...
\tkzDefPoint(0,   27.9){A}\tkzDefPoint(1/27,28.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/27,26.9){A}\tkzDefPoint(1/25,27.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/25,25.9){A}\tkzDefPoint(1/24,27.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/24,25.9){A}\tkzDefPoint(1/22,26.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/22,24.9){A}\tkzDefPoint(1/21,26.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/21,24.9){A}\tkzDefPoint(1/20,26.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/20,24.9){A}\tkzDefPoint(1/18,25.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/18,23.9){A}\tkzDefPoint(1/17,25.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/17,23.9){A}\tkzDefPoint(1/16,25.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/16,23.9){A}\tkzDefPoint(1/15,25.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/15,23.9){A}\tkzDefPoint(1/13,24.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/13,22.9){A}\tkzDefPoint(1/12,24.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/12,22.9){A}\tkzDefPoint(1/11,24.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/11,22.9){A}\tkzDefPoint(1/10,24.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/10,22.9){A}\tkzDefPoint(1/9, 24.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/9, 22.9){A}\tkzDefPoint(1/7, 23.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/7, 21.9){A}\tkzDefPoint(1/6, 23.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/6, 21.9){A}\tkzDefPoint(1/5, 23.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/5, 20.9){A}\tkzDefPoint(1/4, 22.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/4, 19.9){A}\tkzDefPoint(1/3, 20.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/3, 18.9){A}\tkzDefPoint(2/5, 20.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(2/5, 17.9){A}\tkzDefPoint(1/2, 20.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/2, 15.9){A}\tkzDefPoint(2/3, 17.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(2/3, 15.9){A}\tkzDefPoint(3/4, 17.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(3/4, 14.9){A}\tkzDefPoint(1,   16.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1,   12.9){A}\tkzDefPoint(1.1, 14.1){C}\tkzDefRectangle(A,C)\tkzGetPoints{B}{D} \tkzDrawPolygon[fill=black](A,...,D)
\tkzDefPoint(1/27,26.9){A}\tkzDefPoint(1/27,28.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzDefPoint(1/27,3){C}\tkzDrawSegment[color=gray](A,C)\tkzDrawPoints[shape=cross](C)\tkzLabelPoint[right](C){\tiny 1/27}
\tkzDefPoint(1/25,25.9){A}\tkzDefPoint(1/25,27.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzDefPoint(1/25,4){C}\tkzDrawSegment[color=gray](A,C)\tkzDrawPoints[shape=cross](C)\tkzLabelPoint[right](C){\tiny 1/25}
\tkzDefPoint(1/24,25.9){A}\tkzDefPoint(1/24,27.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzDefPoint(1/24,5){C}\tkzDrawSegment[color=gray](A,C)\tkzDrawPoints[shape=cross](C)\tkzLabelPoint[right](C){\tiny 1/24}
\tkzDefPoint(1/22,24.9){A}\tkzDefPoint(1/22,26.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzDefPoint(1/22,6){C}\tkzDrawSegment[color=gray](A,C)\tkzDrawPoints[shape=cross](C)\tkzLabelPoint[right](C){\tiny 1/22}
\tkzDefPoint(1/20,24.9){A}\tkzDefPoint(1/20,26.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzDefPoint(1/20,7){C}\tkzDrawSegment[color=gray](A,C)\tkzDrawPoints[shape=cross](C)\tkzLabelPoint[right](C){\tiny 1/20}
\tkzDefPoint(1/18,23.9){A}\tkzDefPoint(1/18,25.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzDefPoint(1/18,8){C}\tkzDrawSegment[color=gray](A,C)\tkzDrawPoints[shape=cross](C)\tkzLabelPoint[right](C){\tiny 1/18}
\tkzDefPoint(1/15,23.9){A}\tkzDefPoint(1/15,25.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzDefPoint(1/15,9){C}\tkzDrawSegment[color=gray](A,C)\tkzDrawPoints[shape=cross](C)\tkzLabelPoint[right](C){\tiny 1/15}
\tkzDefPoint(1/13,22.9){A}\tkzDefPoint(1/13,24.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzDefPoint(1/13,10){C}\tkzDrawSegment[color=gray](A,C)\tkzDrawPoints[shape=cross](C)\tkzLabelPoint[right](C){\tiny 1/13}
\tkzDefPoint(1/ 9,22.9){A}\tkzDefPoint(1/9, 24.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzLabelPoint[below](A){\tiny 1/9}
\tkzDefPoint(1/ 7,21.9){A}\tkzDefPoint(1/7, 23.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzLabelPoint[below](A){\tiny 1/7}
\tkzDefPoint(1/ 5,20.9){A}\tkzDefPoint(1/5, 23.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzLabelPoint[below](A){\tiny 1/5}
\tkzDefPoint(1/ 4,18.9){A}\tkzDefPoint(1/4, 22.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzLabelPoint[below](A){\tiny 1/4}
\tkzDefPoint(1/ 3,18.9){A}\tkzDefPoint(1/3, 20.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzLabelPoint[below](A){\tiny 1/3}
\tkzDefPoint(2/ 5,17.9){A}\tkzDefPoint(2/5, 20.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzLabelPoint[below](A){\tiny 2/5}
\tkzDefPoint(1/ 2,15.9){A}\tkzDefPoint(1/2, 21.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzLabelPoint[below](A){\tiny 1/2}
\tkzDefPoint(3/ 4,14.9){A}\tkzDefPoint(3/4, 17.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzLabelPoint[below](A){\tiny 3/4}
\tkzDefPoint(1,   12.9){A}\tkzDefPoint(1,   16.1){B}\tkzDrawSegment[color=red,thick](A,B)\tkzLabelPoint[below](A){\tiny 1}
...
\vspace{1cm}
\begin{lemma}[Continuous approximation]
